...
const menuGroups = ref([
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        route: '#',
        children: [
          { label: 'Import product', route: '/admin/provider/import' },
          { label: 'List provider', route: '/admin/provider/list' },
          { label: 'Order provider', route: '/admin/provider/orders' },
        ],
      },
      {
        icon: `boxes-stacked`,
      ...
      },
      {
        ...
        route: '#',
        children: [
          { label: 'List Post', route: '/admin/posts/list' },
          { label: 'Category post', route: '/admin/posts/categories' },
        ],
      },
      {
        icon: 'comment',
        ...
        route: '#',
        children: [
          { label: 'Comment management', route: '/admin/comments' },
        ],
      },
      {
        icon: 'users',
        ...
        route: '#',
        children: [
          { label: 'Customer management', route: '/admin/customers' },
        ],
      },
      {
        icon: 'image-portrait',
